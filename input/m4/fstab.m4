tmpfs                       /var/log            tmpfs   rw,nodev,nosuid,size=1G     0   0
/data/etc/dropbear          /etc/dropbear       none    defaults,bind               0   0
/data/var/lib/rancher       /var/lib/rancher    none    defaults,bind               0   0
/data/etc/rancher           /etc/rancher        none    defaults,bind               0   0
# /var/lib is now managed by the startup script that checks for SSDs
#/data/var/lib               /var/lib            none    defaults,bind,shared        0   0
